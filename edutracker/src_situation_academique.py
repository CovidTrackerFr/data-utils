...
def get_data():
    return pd.read_csv("edutracker/data/fr-en-situation_academique_covid.csv", sep=";").sort_values(by="date")
...
def export_json(data_json):
    with open('edutracker/data/' + 'fr-en-situation_academique_covid.json', 'w', encoding='utf-8') as f:
